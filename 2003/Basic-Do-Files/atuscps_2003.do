...
using "C:\Users\lkarabar\Desktop\ChicagoBooth\Research\Time Use\Data\MyData\ATUS Data\Data for Publication\2003\Basic Original Data Files\atuscps_2003.dat",  names comma ;
...
label variable  hrhhid            "Household identifier (15-digit identifier)";
...
label variable  hrsample          "Sample ID (4-character ID created in Reformat)";
label variable  hrsersuf          "Serial Suffix (identifies extra units)";
label variable  hryear4           "Year of interview";
label variable  hubus             "Does anyone in this household have a business or a farm?";
label variable  hubusl1           "Line number (PULINENO) of farm or business owner (first owner)";
label variable  hubusl2           "Line number (PULINENO) of farm or business owner (second owner)";
label variable  hubusl3           "Line number (PULINENO) of farm or business owner (third owner)";
label variable  hubusl4           "Line number (PULINENO) of farm or business owner (fourth owner)";
label variable  hufaminc          "Household Income (Combined income of all family members during the last 12 months. Includes money from jobs, net income from business, farm or rent, pensions, dividends, interest, Social Security payments and any other money income received by family members who are 15 years of age or older.)";
...
label variable  hurespli          "Line number (PULINENO) of the current respondent";
label variable  huspnish          "Is Spanish the only language spoken by all members of this household who are 15 years and older?";
label variable  hutypb            "Type B non\x1einterview categories";
label variable  hutypc            "Type C non\x1einterview categories";
label variable  hutypea           "ENTER TYPE OF NONINTERVIEW";
label variable  hwhhwgt           "Household weight (4 implied decimals)";
...
label variable  pecyc             "Edited: How many years of college CREDIT (have/has) (you/name) completed?";
label variable  pedipged          "Edited: How did (you/name) get (your/his/her) High School diploma?";
...
label variable  pedwavr           "Edited: Why is that? (Why could you not have started a job if one had been offered last week?)";
...
label variable  peernhry          "Edited: Hourly/Nonhourly Status";
...
label variable  peernrt           "Edited: Even though you told me it is easier to report your earnings (PEERNPER), are you paid at an hourly rate on (this/your main) job?";
label variable  peernuot          "Edited: Do you usually receive overtime pay, tips, or commissions at your job?";
label variable  peernwkp          "Edited: How many weeks a year to you get paid?";
...
label variable  pehrwant          "Edited: Do you want to work a full-time workweek of 35 hours or more per week?";
label variable  pehspnon          "Edited: Are you Spanish, Hispanic, or Latino?";
label variable  peio1cow          "Edited: Individual class of worker for main job";
label variable  peio1icd          "Edited: Industry code for main job";
label variable  peio1ocd          "Edited: Occupation code for main job";
label variable  peio2cow          "Edited: Individual class of worker for second job";
label variable  peio2icd          "Edited: Industry code for second job";
label variable  peio2ocd          "Edited: Occupation code for second job";
...
label variable  pelayavl          "Edited: Could you have returned to work LAST WEEK if you had been recalled?";
...
label variable  pelkavl           "Edited: LAST WEEK, could you have started a job if one had been offered?";
label variable  pelkdur           "Edited: Duration of job seeking (number of weeks)";
label variable  pelkfto           "Edited: Seeking full time or part time job";
...
label variable  pelkm1            "Edited: What are all of the things you have done to find work during the last 4 weeks?";
...
label variable  pemjot            "Edited: Do you have more than one job?";
...
label variable  peparent          "Edited: Line number (PULINENO) of parent";
label variable  peret1            "Edited: Do you currently want a job, either full or part\x1etime?";
...
label variable  pesex             "Edited: Gender";
label variable  pespouse          "Edited: Line number (PULINENO) of spouse";
...
label variable  prernhly          "Hourly Earnings Recode (2 implied decimals)";
label variable  prernwa           "Weekly earnings recode (2 implied decimals)";
...
label variable  prhernal          "Hourly Earnings Recode Flag";
...
label variable  proldrrp          "RECODE FROM NEW TO OLD RRP CODES";
...
label variable  prunedur          "Duration of unemployment for layoff and looking records (number of weeks)";
label variable  pruntype          "Reason for unemployment";
label variable  prwernal          "Weekly earnings recode flag";
...
label variable  ptdtrace          "Top Coded Race";
...
label variable  puafever          "Ever worked for U.S. Armed Forces?";
...
label variable  pudis             "Last month you were reported to have a disability. Does your disability continue to prevent you from doing any kind of work for the next 6 months?";
label variable  pudis1            "Does your disability prevent you from doing any kind of work for the next 6 months?";
label variable  pudis2            "Do you have a disability that prevents you from doing any kind of work for the next 6 months?";
...
label variable  puhrot1           "LAST WEEK, did you work any overtime or extra hours (at your MAIN job? )";
...
label variable  puiock1           "I and O check item 1: filter for dependent I and O";
label variable  puiock2           "I and O check item 2: filter for previous month's I and O cases";
label variable  puiock3           "I and O check item 3: Filter for previous month's unknown occupation";
label variable  puiodp1           "Last month you were reported to work for (employer's name). Do you still work for (employer's name) (at your main job)?";
label variable  puiodp2           "Have the usual activities and duties of your job changed since last month?";
label variable  puiodp3           "Is this an accurate description of your current job?";
label variable  pujhck1           "Job history check item 1: filter for outgoing rotations";
label variable  pujhck2           "Job history check item 2: filter for persons going through I and O series";
...
label variable  pulayck3          "Layoff Check Item 3: dependent I and O filter/carryover";
label variable  pulaydt           "Has your employer given you a date to return to work?";
label variable  pulineno          "Line number";
...
label variable  puretot           "Last month you were reported to be retired. Are you still retired this month?";
...
label variable  pwcmpwgt          "Composite weight (4 implied decimals)";
label variable  pwfmwgt           "Family weight (4 implied decimals)";
label variable  pwlgwgt           "Longitudinal weight (4 implied decimals)";
label variable  pworwgt           "Outgoing rotation weight (4 implied decimals)";
label variable  pwsswgt           "Second stage weight (4 implied decimals)";
label variable  pwvetwgt          "Veteran weight (4 implied decimals)";
...
label variable  pxafwhen          "PEAFWHEN: allocation flag";
...
label variable  txnewrace         "Flag indicating whether PTDTRACE is imputed";
...
5     "MH or trailer w/ no permanent room added"
6     "MH or trailer w/ 1 or more rooms added"
...
2     "Husband/Wife Prim Family (either/both Armed Forces)"
...
-2    "Don't Know"
-3    "Refused"
0     "Mis 1 Or Replacement Hh (No Link To Prior Month)"
2     "Mis 2-4 Or Mis 6-8 (Link To Previous Month)"
;
...
5     "Nonagricultural, wage/salary, private households"
6     "Nonagricultural, wage/salary, other private"
7     "Nonagricultural, wage/salary, Federal government"
8     "Nonagricultural, wage/salary, state government"
9     "Nonagricultural, wage/salary, local government"
10    "Nonagricultural, self-employed"
11    "Nonagricultural, unpaid"
;
...
-2    "Don't Know"
-3    "Refused"
1     "Non-Ag Private Wage And Salary"
;
...
;
label define labelproldrrp
-1    "Blank"
-2    "Don't Know"
-3    "Refused"
1     "Ref Pers w relatives"
2     "Ref Pers w/o relatives"
3     "Spouse"
4     "Child"
5     "Grandchild"
6     "Parent"
...
9     "Foster Child"
10    "Nonrel of Ref Per w/ own rels in HH"
11    "Partner/Roommate"
12    "Nonrel of Ref Per w/o own rels in HH"
;
...
13    "Other Passive"
;
label define labelpunlfck1
-1    "Blank"
-2    "Don't Know"
-3    "Refused"
1     "If AGERNG Equals 1-4 or 9 Goto NLFACT"
2     "All Others Goto NLFRET"
;
label define labelpunlfck2
-1    "Blank"
-2    "Don't Know"
-3    "Refused"
1     "MISCK Equals 4 Or 8 Then Goto NLFJH"
2     "All Other Rotations, End Questions"
;
...
53    "Refused To Blank"
;
label define labeltxnewrace
-1    "Blank"
-2    "Don't Know"
-3    "Refused"
0     "Not imputed"
1     "Assigned new race based on a discontinued race variable that was not imputed (PXRACE1=0)"
2     "Assigned new race based on a discontinued race variable that was imputed (PXRACE1>0)"
;
...
label values    proldrrp          labelproldrrp;
...
label values    pxafwhen          labelpxafwhen;
...
label values    txnewrace         labeltxnewrace;
...
save "C:\Users\lkarabar\Desktop\ChicagoBooth\Research\Time Use\Data\MyData\ATUS Data\Data for Publication\2003\Basic Transformed Data Files\atuscps_2003.dta" ;
